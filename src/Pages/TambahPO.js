...
const tambahPackages = "https://ec2-54-179-157-83.ap-southeast-1.compute.amazonaws.com/api/users/packages";
const tambahSupp = "https://ec2-54-179-157-83.ap-southeast-1.compute.amazonaws.com/api/users/suppliers";
...
class TambahPO extends Component {
  ...
  handlePost = event => {
    ...
    axios
      .post(
        "https://ec2-54-179-157-83.ap-southeast-1.compute.amazonaws.com/api/users/po",
        {
