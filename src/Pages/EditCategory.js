...
class EditCategory extends Component {
    ...
    componentDidMount = () => {
        ...
        axios
            .get("https://ec2-54-179-157-83.ap-southeast-1.compute.amazonaws.com/api/users/category/" + this.props.match.params.id, { headers })
            .then(response => {
    ...
    handlePost = event => {
        ...
        axios
            .put(
                "https://ec2-54-179-157-83.ap-southeast-1.compute.amazonaws.com/api/users/category/" + id,
                {
