...
class EditCustomers extends Component {
  ...
  componentDidMount = () => {
    ...
    axios
        .get("https://ec2-54-179-157-83.ap-southeast-1.compute.amazonaws.com/api/users/customers/" + this.props.match.params.id,{headers})
        .then(response => {
    ...
    handlePost = event => {
      ...
      axios
          .put(
          "https://ec2-54-179-157-83.ap-southeast-1.compute.amazonaws.com/api/users/customers/" + id,
          {
