...
const getAllItem = "http://ec2-54-255-236-0.ap-southeast-1.compute.amazonaws.com/api/users/item";
class EditPackages extends Component {
  ...
  componentWillMount = () => {
    ...
    axios
      .get("http://ec2-54-255-236-0.ap-southeast-1.compute.amazonaws.com/api/users/packages/" + this.props.match.params.id,{headers})
      .then(response => {
  ...
  handlePost = event => {
    ...
    axios
      .put(
        "http://ec2-54-255-236-0.ap-southeast-1.compute.amazonaws.com/api/users/packages/"+id,
        {
