...
const getAllItem = "http://ec2-54-179-157-83.ap-southeast-1.compute.amazonaws.com:5000/api/users/category";
...
class TambahItem extends Component {
  ...
  handlePost = event => {
    ...
    axios
      .post(
        "http://ec2-54-179-157-83.ap-southeast-1.compute.amazonaws.com:5000/api/users/item",
        {
