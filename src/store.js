...
const actions = store => ({
  ...
  handleSearch: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/item?search=" + keyword, {
        headers: {
  ...
  handleSearchCategory: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/category?search=" + keyword, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  handleSearchPackages: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/packages?search=" + keyword, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  handleSearchSummary: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/summary?search=" + keyword, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  handleSearchSuppliers: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/suppliers?search=" + keyword, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  handleSearchCustomers: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/customers?search=" + keyword, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  handleSearchTransactions: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/posalestransactions?search=" + keyword, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  handleSearchSales: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/sales?search=" + keyword, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  handleSearchPurchaseOrder: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/po?search=" + keyword, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  handleSearchQrCode: async (state, keyword, token) => {
    await axios
      .get("https://appware-api.halte.id/api/users/track?code=" + keyword, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getAllItems: async (state, token) => {
    ...
    await axios
      .get("https://appware-api.halte.id/api/users/item", {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getAllCategory: async (state, token) => {
    // console.log('Token getAllItems', token)
    await axios
      .get("https://appware-api.halte.id/api/users/category", {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getAllPackages: async (state, token) => {
    // console.log('Token getAllItems', token)
    await axios
      .get("https://appware-api.halte.id/api/users/packages", {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getSuppliers: async (state, token) => {
    // console.log('Token getAllItems', token)
    await axios
      .get("https://appware-api.halte.id/api/users/suppliers", {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getCustomers: async (state, token) => {
    // console.log('Token getAllItems', token)
    await axios
      .get("https://appware-api.halte.id/api/users/customers", {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getAllTransactions: async (state, token, dateBefore, dateAfter) => {
    ...
    // alert(dateAfter)
    await axios
      .get("https://appware-api.halte.id/api/users/posalestransactions?dateStart="+dateBefore+"&dateEnd="+dateAfter, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getAllPurchaseOrder: async (state, token, dateBefore, dateAfter) => {
    ...
    // alert(dateAfter)
    await axios
      .get("https://appware-api.halte.id/api/users/po?dateStart="+dateBefore+"&dateEnd="+dateAfter, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getAllSales: async (state, token, dateBefore, dateAfter) => {
    ...
    // alert(dateAfter)
    await axios
      .get("https://appware-api.halte.id/api/users/sales?dateStart="+dateBefore+"&dateEnd="+dateAfter, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getAllSummary: async (state, token, dateBefore, dateAfter) => {
    ...
    await axios
      .get("https://appware-api.halte.id/api/users/summary?dateStart="+dateBefore+"&dateEnd="+dateAfter, {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getJustSummary: async (state, token) => {
    ...
    // alert(dateAfter)
    await axios
      .get("https://appware-api.halte.id/api/users/summary", {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  getAllQrCode: async (state, token, dateBefore, dateAfter) => {
    ...
    // alert(dateAfter)
    await axios
      .get("https://appware-api.halte.id/api/users/track", {
        headers: {
          Authorization: "Bearer " + token
        }
      })
  ...
  postLogin: async (state, email, password) => {
    ...
    await axios
      .post("https://appware-api.halte.id/api/users/login", data)
      .then((response) => {
  ...
  getEmployees: async (state, token) => {
    console.log('Token getAllItems', token)
    await axios
      .get("https://appware-api.halte.id/api/users/subusers", {
        headers: {
          Authorization: "Bearer " + token
        }
      })
